...
def main():
    resume_from_job_dir = Path('results/job_vit_noninteracting_lx3ly3_nf3_gpu_20260219_500steps_fullsum_resume500')
    resume_from_params = resume_from_job_dir / 'train.mpack'
    job_dir = Path('results/job_vit_noninteracting_lx3ly3_nf3_gpu_20260219_4000steps_resume_from1000')
